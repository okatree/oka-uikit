...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px" }, isPushed ? (React.createElement(Icon$w, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$x, { width: "24px", color: "textSubtle" }))),
